...
import {
  ...
  CheckCircle2, Loader2, Upload, X, Sparkles
} from 'lucide-react';
  ...
  return (
    <div style={{ background: 'var(--background)', minHeight: '100vh' }}>
      ...
      <div style={{ display: 'flex', minHeight: 'calc(100vh - 53px)' }}>
        {/* Main Content — Overview only, no tabs */}
        ...
        <div className="right-panel">
          <div style={{ padding: '12px 14px', borderBottom: '1px solid var(--border)' }}>
            ...
            <div style={{ display: 'flex', gap: 8 }}>
              ...
              <button onClick={() => navigate('/dashboard')} className="btn-primary" style={{ flex: 1, justifyContent: 'center', fontSize: 12, height: 34 }}>
                <Plus size={12} /> New
              </button>
            </div>
          </div>
